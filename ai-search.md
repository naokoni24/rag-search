...
- 2026-07-19に検索ボックス(`.search-form input[type="text"]`)の`font-size`をトークン値(`--text-md`、
  0.94rem≈15px)から`16px`固定に変更。16px未満だとiOS Safariがフォーカス時にページ全体を自動ズームして
  しまい、検索後に再度検索ボックスをタップすると画面が拡大される不具合があった
